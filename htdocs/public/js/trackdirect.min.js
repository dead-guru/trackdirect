...
distanceDiv.append('<span title="Current shown tail distance (depends on the time settings)">Поточна довжина руху: '+
tailDistance+
" "+
tailDistanceUnit+
...
'"); return false;');var coveragePolygon=this._defaultMap.markerCollection.getStationCoverage(this._marker.packet.station_id);if(coveragePolygon!==null&&coveragePolygon.isRequestedToBeVisible()){menuLink.html("Hide Coverage");}else{menuLink.html("Покриття");}
